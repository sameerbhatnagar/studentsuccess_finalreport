...
/****** Object:  StoredProcedure [dbo].[LoadData]    Script Date: 5/24/2017 4:55:37 PM ******/
SET ANSI_NULLS ON
GO
...
--------------------------------------------
   ...
   delete from [dbo].[StudentCertification]
--------------------------------------------
-- step 2 insert data from view to tables
--------------------------------------------   
	...
	set @str='bcp  "select * from StudentSuccess.dbo.Admission" queryout  E:\StudentSuccess\Admission.txt  -T -f E:\StudentSuccess\Admission.fmt'  
	exec xp_cmdshell @str
    ...
    set @str='bcp  "select * from StudentSuccess.dbo.EtudiantSession" queryout  E:\StudentSuccess\EtudiantSession.txt  -T -f E:\StudentSuccess\EtudiantSession.fmt'  
	exec xp_cmdshell @str
	...
	set @str='bcp  "select * from StudentSuccess.dbo.Cours" queryout  E:\StudentSuccess\Cours.txt  -T -f E:\StudentSuccess\Cours.fmt'  
	exec xp_cmdshell @str
	...
	set @str='bcp  "select * from StudentSuccess.dbo.EtudesPrecedentes" queryout  E:\StudentSuccess\EtudesPrecedentes.txt  -T -f E:\StudentSuccess\EtudesPrecedentes.fmt'  
	exec xp_cmdshell @str
	...
	insert into dbo.StudentCertification
	select * from dbo.vwStudentCertification


	set @str='bcp  "select * from StudentSuccess.dbo.StudentCertification" queryout  E:\StudentSuccess\StudentCertification.txt  -T -f E:\StudentSuccess\StudentCertification.fmt'  
	exec xp_cmdshell @str
